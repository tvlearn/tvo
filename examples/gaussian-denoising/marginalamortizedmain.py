...
from amortization.models.amortizedbernoulli import SamplerType, MarginalBernoulli
from amortization.models.variationalparams import ResNetMarginalVariationalParams
...
def gaussian_denoising_example():  # noqa: C901
    ...
    variationalparams = ResNetMarginalVariationalParams(N=0, D=D, H=args.H)
