...
from amortization.models.amortizedbernoulli import SamplerType, SequenceBernoulli
from amortization.models.variationalparams import ResNetSequenceVariationalParams, LinearSequenceVariationalParams
...
def gaussian_denoising_example():  # noqa: C901
    ...
    variationalparams = ResNetSequenceVariationalParams(N=0, D=D, H=args.H)
