...
class Trainer:
    def __init__(
        self,
        model: Trainable,
        train_data: Union[TVODataLoader, to.Tensor] = None,
        train_states: TVOVariationalStates = None,
        test_data: Union[TVODataLoader, to.Tensor] = None,
        test_states: TVOVariationalStates = None,
        ...
        :param train_states: TVOVariationalStates with shape (N,S,H)
        :param test_data: validation or test dataset. The contained dataset should have shape (M,D)
        :param test_states: TVOVariationalStates with shape (M,Z,H)
